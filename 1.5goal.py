...
collection1=db_over_under["Over/Under 1.5 Goals"]
...
async def over_under_traitement(a,data1,a1,*args,**kwargs):
    ...
    if marge <0.21 and over_betkeen<9 and under_betkeen<9:
        ...
        if value:
            ...
            {'id_1_5_1xbet': v["id_1_5_1xbet"],"market":v["market"],"events_1xbet":v["events_1xbet"],"but":v["but"]},
            {'$set': v},
            upsert=True
    ...
    if inverse_sum<0.99:
        ...
        {'id_1_5_1xbet': b["id_1_5_1xbet"],"market":b["market"]},
        {'$set': b},
        upsert=True
        )# Vérification du résultat
        if result.upserted_id:
