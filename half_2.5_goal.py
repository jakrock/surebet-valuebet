...
async def over_under_traitement(a,data1,a1,*args,**kwargs):
    ...
    if marge <0.09 and over_betkeen<12 and under_betkeen<13:
        ...
        if value:
            ...
            {'id_half_1_5_1xbet': v["id_half_1_5_1xbet"],"market":v["market"],"events_1xbet":v["events_1xbet"],"but":v["but"]},
            {'$set': v},
            upsert=True
    ...
    if inverse_sum<0.99:
        ...
        {'id_half_1_5_1xbet': b["id_half_1_5_1xbet"],"market":b["market"],"events_1xbet":b["events_1xbet"],"but":b["but"]},
        {'$set': b},
        upsert=True
        )# Vérification du résultat
        if result.upserted_id:
